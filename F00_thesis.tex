...
%Titles
\title{Design parameters influence on spark length and tone quality in a musical dual resonant solid state tesla coil}
...
\input{src/DRSSTC_detalj}
%Inngående beskrivelse av signaler i kretsene
\input{src/DRSSTC_signals}
