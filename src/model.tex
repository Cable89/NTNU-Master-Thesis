...
Shown in \cref{fig:bode} is the bode plot of the transfer function $H(s)$ \cref{eq:5} of the resonant circuit with the orders of magnitude in \cref{tab:mod_params}. Where the value for $G_1$ is the minimum conductance possible when there is no electrical discharge. With electrical discharge (streamer or corona) the conductance will increase.
...
\Cref{fig:bode_r1} shows the bode plot of the transfer function for the resonant circuit $H(s)$ with 5 different values for $R_1$, $0\Omega$, $1\Omega$, $5\Omega$, $10\Omega$, and $100\Omega$.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\Cref{fig:bode_g1} shows the bode plot of the transfer function for the resonant circuit $H(s)$ with 5 different values for $G_1$, $1e12{\Omega}^{-1}$, $1e3{\Omega}^{-1}$, $1e-6{\Omega}^{-1}$, $1e-12{\Omega}^{-1}$, and $0{\Omega}^{-1}$.
...
\Cref{fig:fbbode_g1} shows the bode plot of the transfer function for the current in the primary resonant circuit $H_{FB}(s)$ with 5 different values for $G_1$, $1e-3{\Omega}^{-1}$, $1e-4{\Omega}^{-1}$, $1e-4{\Omega}^{-1}$, $1e-5{\Omega}^{-1}$, and $0{\Omega}^{-1}$.
\begin{figure}[H]
    \centering
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\Cref{fig:bode_c1} shows the bode plot of the transfer function for the resonant circuit $H(s)$ with 5 different values for $C_1$, $0.1C_1$, $0.8C_1$, $1.0C_1$, $1.2C_1$, $10C_1$. Where $C_1 = 1 \cdot 10^{-7}$F.
...
\Cref{fig:fbbode_c1} shows the bode plot of the transfer function for the current in the primary resonant circuit $H_{FB}(s)$ with 5 different values for $C_1$, $0.1C_1$, $0.8C_1$, $1.0C_1$, $1.2C_1$, $10C_1$. Where $C_1 = 1 \cdot 10^{-7}$F.
\begin{figure}[H]
    \centering
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\Cref{fig:bode_c2} shows the bode plot of the transfer function for the resonant circuit $H(s)$ with 5 different values for $C_2$; $0.01C_2$, $0.1C_2$, $1.0C_2$, $10C_2$, $100C_2$. Where $C_2 = 1 \cdot 10^{-11}$F.
...
\Cref{fig:fbbode_c2} shows the bode plot of the transfer function for the current in the primary resonant circuit $H_{FB}(s)$ with 5 different values for $C_2$; $0.01C_2$, $0.1C_2$, $1.0C_2$, $10C_2$, $100C_2$. Where $C_2 = 1 \cdot 10^{-11}$F.
\begin{figure}[H]
    \centering
