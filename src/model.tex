...
Here we see that we have a damped sinusiodal response with a frequency in the order of magnitude 1e5, wich attenuates quickly.
\todo{Skriv om å variere parametre}

\newpage
\Cref{fig:polezero} shows the poles and zeros of the transfer function of the coil rig.
...
\newpage
\Cref{fig:linsim} shows the result of a linear simulation of the transfer function of the resonant circuit with a square wave input signal with amplitude 1 and frequency 159kHz.
...
\newpage
\Cref{fig:fb_step} shows the step and impulse response of the feedback transfer function.
